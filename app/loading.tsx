export default function Loading() {
  return (
    <div className="lg:ml-64 pt-14 fixed inset-0 flex flex-col items-center justify-center bg-black z-50">
      <div className="w-full max-w-sm px-6 space-y-6">
        ...
        <div className="h-px bg-white/5 w-full overflow-hidden">
          <div className="h-full bg-primary animate-[progress_1.8s_ease-in-out_infinite]" />
        </div>
